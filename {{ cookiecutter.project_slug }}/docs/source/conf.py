...
latex_documents = [
    (root_doc, '{{cookiecutter.project_slug}}.tex', u'{{cookiecutter.project_name}} Documentation',
     author, 'manual'),
]
...
man_pages = [
    (root_doc, '{{cookiecutter.project_slug}}', u'{{cookiecutter.project_name}} Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (root_doc, '{{cookiecutter.project_slug}}', u'{{cookiecutter.project_name}} Documentation',
     author, '{{cookiecutter.project_slug}}', '{{cookiecutter.short_description}}',
     'Miscellaneous'),
]
